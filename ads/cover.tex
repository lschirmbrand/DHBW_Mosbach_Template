...
\begin{titlepage}
	\begin{longtable}{p{8cm} p{8cm}}
		\raggedright {\raisebox{\ht\strutbox-\totalheight}{\includegraphics[height=2cm]{images/cover/logo-dhbw.pdf}}} &
		% no company logo for semester paper and special documents
		\ifDocType{T2\_3100}{}{%
			\ifSpecialDocument{}{%
				\raggedleft {\raisebox{\ht\strutbox-\totalheight}{\includegraphics[height=1cm]{images/cover/logo-company.png}}}
			}%
		}%
	\end{longtable}
